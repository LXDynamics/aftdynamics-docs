...
export async function generateAllFiles(
  ...
  for (const [filename, content] of Object.entries(files)) {
    if (useFileSystem) {
      ...
      throw new Error('Either useFileSystem must be true or actions must be provided');
    }
  }
}
    ...
    posts: [
      {
        ...
        metadata: {
          ...
          title: 'Welcome to AFT Dynamics',
          description: 'Introducing our revolutionary rocket engine cluster technology',
      ...
      },
      {
        ...
        metadata: {
          ...
          description: 'Deep dive into our innovative engine cluster design and turbogenerator technology',
