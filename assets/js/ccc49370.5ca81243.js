  ...
  [249],
  {
    1689: (e, t, n) => {
      ...
      function l({ className: e }) {
        return (0, o.jsx)(r.A, {
          type: "caution",
          title: (0, o.jsx)(s.Yh, {}),
          className: (0, a.A)(e, i.G.common.draftBanner),
          children: (0, o.jsx)(s.TT, {}),
        });
      }
      var c = n(2234);
    ...
    2234: (e, t, n) => {
      ...
      function l({ className: e }) {
        return (0, o.jsx)(r.A, {
          type: "caution",
          title: (0, o.jsx)(s.Rc, {}),
          className: (0, a.A)(e, i.G.common.unlistedBanner),
          children: (0, o.jsx)(s.Uh, {}),
        });
      }
      function c(e) {
        return (0, o.jsxs)(o.Fragment, {
          children: [(0, o.jsx)(s.AE, {}), (0, o.jsx)(l, { ...e })],
        });
      }
    },
    2907: (e, t, n) => {
      ...
      var o = n(8774);
      const l = { title: "title_f1Hy" };
      function c({ className: e }) {
        const { metadata: t, isBlogPostPage: n } = (0, s.e7)(),
          { permalink: r, title: c } = t,
          d = n ? "h1" : "h2";
        return (0, i.jsx)(d, {
          className: (0, a.A)(l.title, e),
          children: n ? c : (0, i.jsx)(o.A, { to: r, children: c }),
        });
      }
      var d = n(1312),
        m = n(5846),
        u = n(6266);
      const h = { container: "container_mt6G" };
              ...
              (0, d.T)(
                {
                  ...
                  description:
                    'Pluralised label for "{readingTime} min read". Use as much plural forms (separated by "|") as your language support (see https://www.unicode.org/cldr/cldr-aux/charts/34/supplemental/language_plural_rules.html)',
      ...
      function f({ date: e, formattedDate: t }) {
      ...
      function p({ className: e }) {
        ...
        return (0, i.jsxs)("div", {
          className: (0, a.A)(h.container, "margin-vert--md", e),
          children: [
            (0, i.jsx)(f, {
              date: n,
              formattedDate: ((l = n), o.format(new Date(l))),
            }),
            void 0 !== r &&
              (0, i.jsxs)(i.Fragment, {
                children: [
                  (0, i.jsx)(x, {}),
                  (0, i.jsx)(g, { readingTime: r }),
                ],
              }),
          ],
        });
        ...
        return (0, i.jsx)("div", {
          ...
          children: t.map((e, t) =>
            (0, i.jsx)(
              ...
              {
                className: (0, a.A)(
                  !r && (o ? "col col--12" : "col col--6"),
                  r ? j.imageOnlyAuthorCol : j.authorCol
                ),
                children: (0, i.jsx)(v.A, {
                  author: {
                    ...e,
                    imageURL: n.authorsImageUrls[t] ?? e.imageURL,
                  },
                }),
              },
              t
      ...
      function L({ children: e, className: t }) {
        const { isBlogPostPage: n } = (0, s.e7)();
        return (0, i.jsx)("div", {
          id: n ? N.LU : void 0,
          className: (0, a.A)("markdown", t),
          children: (0, i.jsx)(y.A, { children: e }),
        });
      }
      var _ = n(7559),
        C = n(4336),
          ...
          children: [
            ...
            m &&
              (0, i.jsx)("div", {
                ...
                children: (0, i.jsx)(k, { blogPostTitle: r, to: e.permalink }),
              }),
          ],
        });
      }
    ...
    3858: (e, t, n) => {
      ...
      function v({ sidebar: e, children: t }) {
        const { metadata: n, toc: a } = (0, r.e7)(),
          { nextItem: s, prevItem: i, frontMatter: c } = n,
          {
            hide_table_of_contents: d,
            toc_min_heading_level: h,
            toc_max_heading_level: g,
          } = c;
        return (0, m.jsxs)(o.A, {
          sidebar: e,
          toc:
            !d && a.length > 0
              ...
              : void 0,
          children: [
            (0, m.jsx)(p.A, { metadata: n }),
            (0, m.jsx)(l.A, { children: t }),
            (s || i) && (0, m.jsx)(u, { nextItem: s, prevItem: i }),
          ],
        });
      }
      function j(e) {
    ...
    5195: (e, t, n) => {
      ...
      function l(e, { anchorTopOffset: t }) {
        const n = e.find((e) => o(e).top >= t);
        if (n) {
          return (function (e) {
      ...
      var m = n(8774),
        u = n(4848);
      function h({ toc: e, className: t, linkClassName: n, isChild: a }) {
        return e.length
          ? (0, u.jsx)("ul", {
      ...
      function f({
        ...
        linkClassName: n = "table-of-contents__link",
        ...
        const h = (0, s.p)(),
          f = l ?? h.tableOfContents.minHeadingLevel,
          x = c ?? h.tableOfContents.maxHeadingLevel,
          p = (function ({ toc: e, minHeadingLevel: t, maxHeadingLevel: n }) {
            return (0, a.useMemo)(
              () => r({ toc: i(e), minHeadingLevel: t, maxHeadingLevel: n }),
              [e, t, n]
            );
          })({ toc: e, minHeadingLevel: f, maxHeadingLevel: x });
        return (
          d(
            (0, a.useMemo)(() => {
              if (n && o)
    ...
    7763: (e, t, n) => {
      ...
      const o = "table-of-contents__link toc-highlight",
        l = "table-of-contents__link--active";
      function c({ className: e, ...t }) {
        return (0, r.jsx)("div", {
          className: (0, a.A)(i.tableOfContents, "thin-scrollbar", e),
